...
# Association table for many-to-many between Employee and Meeting
...
class Assignment(db.Model):
    ...
    def __repr__(self):
        return f'<Assignment {self.role}, {self.start_date}, {self.end_date}, {self.employee.name}, {self.project.title}>'
